...
Now we have a method to build a secure from a secure PRP from a secure PRF. Essentially we have an efficient method construct invertible functions from normal functions.
